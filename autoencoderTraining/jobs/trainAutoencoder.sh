...
#SBATCH -o kl-f8.o%j       # Name of stdout output file
#SBATCH -e kl-f8.e%j       # Name of stderr error file
...
apptainer exec --nv /scratch/10122/thomaswynn7394/containers/ml_thomas_latest.sif python3 /scratch/10122/thomaswynn7394/latentDiffusion/autoencoderTraining/trainAutoencoder.py