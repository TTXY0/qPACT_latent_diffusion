...
if __name__ == "__main__":
    ...
    config_paths = {
        'super': '/scratch/10122/thomaswynn7394/latentDiffusion/autoencoderTraining/configs/config_super_f16.yaml',
        'local': '/workspace/thomas/latentDiffusion/autoencoderTraining/configs/config_local_f16.yaml'
    }
