...
apptainer exec --nv /scratch/10122/thomaswynn7394/containers/ml_thomas_latest.sif \
    bash -c "pip install --user matplotlib --exists-action i -q && python3 /scratch/10122/thomaswynn7394/latentDiffusion/autoencoderTraining/training/trainAutoencoder_f8.py"
