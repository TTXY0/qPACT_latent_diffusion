...
def show_images(original, reconstructions, save_path=None):
    ...
    for col in range(3):
        ...
        im = ax[col].imshow(image, cmap='viridis')
        ax[col].axis("off")
...
if __name__ == "__main__":
    ...
    for img_number in range(3):
        ...
        index += 1
    save_path = f"/workspace/thomas/latentDiffusion/autoencoderTraining/scripts/imgs/autoencoder_recon_{img_number}_white.png"
