...
from models.autoencoder_linear_compression import AutoencoderKL
import pickle
import numpy as np
...
if __name__ == "__main__":
    ...
    config_paths = {
        ...
        'local': '/workspace/thomas/latentDiffusion/autoencoderTraining/configs/config_local_k2000.yaml'
    }
