# Loss function has MSE Latent Space, MS_SSIM for Pixel Space
...
from autoencoderTraining.models.combined_autoencoder_v2 import image_autoencoder as AutoencoderKL
import pickle
import numpy as np
...
VER_NAME = "full_autoencoder"
config_path = '/workspace/thomas/latentDiffusion/autoencoderTraining/configs/config_local_full_autoencoder.yaml'
...
if __name__ == "__main__":
    ...
    checkpoint_callback = ModelCheckpoint(monitor='val/latent_loss', save_top_k=3, mode='min')
    image_logger = ImageLoggingCallback(every_n_steps=500)
    early_stopping_callback = EarlyStopping(monitor='val/latent_loss', patience=3, mode='min', verbose=True)
